...
void
gt_ggc_mx_irange_storage_slot (void *x_p)
{
  struct irange_storage_slot * const x = (struct irange_storage_slot *)x_p;
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_mx (&((*x).m_ints));
    }
...
void
gt_ggc_mx_frange_storage_slot (void *x_p)
{
  struct frange_storage_slot * const x = (struct frange_storage_slot *)x_p;
  if (ggc_test_and_set_mark (x))
    {
    }
}
...
void
gt_pch_nx_irange_storage_slot (void *x_p)
{
  struct irange_storage_slot * const x = (struct irange_storage_slot *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_19irange_storage_slot))
    {
      gt_pch_nx (&((*x).m_ints));
    }
}
...
void
gt_pch_nx_frange_storage_slot (void *x_p)
{
  struct frange_storage_slot * const x = (struct frange_storage_slot *)x_p;
  if (gt_pch_note_object (x, x, gt_pch_p_19frange_storage_slot))
    {
    }
}
...
void
gt_pch_p_19irange_storage_slot (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct irange_storage_slot * x ATTRIBUTE_UNUSED = (struct irange_storage_slot *)x_p;
  if ((void *)(x) == this_obj)
    gt_pch_nx (&((*x).m_ints), op, cookie);
}
...
void
gt_pch_p_19frange_storage_slot (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct frange_storage_slot * x ATTRIBUTE_UNUSED = (struct frange_storage_slot *)x_p;
}
